          ...
          <div className="mx-auto w-5xl p-6 sm:px-12 lg:px-16 border-x border-neutral-900 flex flex-col h-screen overflow-y-auto">
            ...
            <div className="mt-20 md:mt-16 lg:mt-20 flex gap-14 flex-col text-center justify-center">
                ...
                <div className="border overflow-x-hidden text-md md:text-2xl leading-6 md:leading-8 lg:leading-12 sm:w-xl md:w-3xl lg:w-4xl mx-auto tracking-normal font-poem text-chars border-accent text-center transition duration-200 bg-cards p-6 rounded-lg shadow-md cursor-pointer shadow-cards/20 ">
                    ...
                    Sat amidst in warplace, a dwelling is wondering <br/>
                    Mists and screams, solemn and
                    cries, hovering,  <br/>
                    It&#39;s a habitat of the concrete itself, <br/>
                    Saw the habitants, leaving and suffering. <br/>

                    It never aged, as the situation of this Holy <br/>
                    Land has been full of Tags and Toes, <br/>
                    “Paradise on Earth”, the huge contrast, only <br/>
                    this Dwelling knows, <br/>
                    The cluster of bricks, still standing with Hope <br/>
                    It&#39;s habitants might return, incarnating David
                    Diop. <br/>

                    It has seen firearms, heard protests, felt the
                    terror, witnessed percussions <br/>
                    Now it craves for arms, feet, and tears of an
                    infant and it&#39;s nurturers.
                </div>
            </div>
          </div>
        </div>
